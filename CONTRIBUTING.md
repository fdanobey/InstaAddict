# Contributing to InstaAddict

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to InstaAddict and its associated repos, which are hosted in the [InstaAddict Organization](https://github.com/gramaddict) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
We have a detailed FAQ and docs website where you can learn how to use InstaAddict: [https://docs.gramaddict.org/](https://docs.gramaddict.org/)
...
If you can't find the answer or want to chat with other people using InstaAddict; you can join the official InstaAddict discord server. Here there are many active members of the community - as well as the development team -  who chime in with helpful advice if you have questions.
  ...
  - [Discord Server](https://discord.gg/dtuaVEuuu) - If you've never joined before, use the [Invite Link](https://discord.gg/PvxsP8HFa)
    ...
    - Use the `#development` channel for questions or discussion about writing or contributing to InstaAddict packages
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started InstaAddict, e.g. which command exactly you used in the terminal, or how you started InstaAddict otherwise. When listing steps, **don't just say what you did, but explain how you did it**. For example, provide the arguments you ran it with.
* **Provide specific examples to demonstrate the steps**. Include links to files or GitHub projects, or copy/pasteable snippets, which you use in those examples. If you're providing snippets in the issue, use [Markdown code blocks](https://help.github.com/articles/markdown-basics/#multiple-lines).
* **Describe the behavior you observed after following the steps** and point out what exactly is the problem with that behavior.
* **Explain which behavior you expected to see instead and why.**
* **If you're reporting that InstaAddict crashed**, please open a ticket on discord, upload the crash file there, and then provide the ticket number in the issue.
...
* **Which version of InstaAddict are you using?** You can get the exact version by checking the log when you run the script.
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps or point out the part of InstaAddict which the suggestion is related to. You can use [this tool](https://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and [this tool](https://github.com/colinkeenan/silentcast) or [this tool](https://github.com/GNOME/byzanz) on Linux.
* **Explain why this enhancement would be useful** to most InstaAddict users.
* **Specify which version of InstaAddict you're using.** You can get the exact version by checking the log when you run the script.
* **Specify the name and version of the OS you're using.**
* **Specify the model of phone/tablet or name and version number of the emulator you are using.**
* **Specify the version of Instagram you are running.**
...
Unsure where to begin contributing to InstaAddict? You can start by looking for `beginner` and `help-wanted` issues:
...
If you want to read about using InstaAddict or developing packages in InstaAddict, the [InstaAddict Docs](https://doc.gramaddict.org) are available to assist with every aspect of InstaAddict.
...
- Maintain InstaAddict's quality
- Fix problems that are important to users
- Engage the community in working toward the best possible InstaAddict
- Enable a sustainable system for InstaAddict's maintainers to review contributions
